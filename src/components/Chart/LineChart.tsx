...
function ChartLegend() {
  return (
    <div
      className="flex w-full flex-wrap items-center justify-center gap-y-2"
      style={{ columnGap: CHART_LEGEND_GAP }}
    >
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full min-w-0 flex-col items-center gap-2">
        <div className="w-full min-w-0" style={{ height: CHART_BODY_HEIGHT }}>
